"""
ArcHeli v1.0.0 — Feedback Engine
...
logger = logging.getLogger("archeli.feedback")
...
class FeedbackEngine:
    ...
    def on_task_success(self, task_id: int, title: str, skill_name: str,
        ...
        content = (f"[ArcHeli] Task SUCCESS — {title}\n"
    ...
    def on_task_failure(self, task_id: int, title: str, skill_name: str,
                        error_msg: str) -> None:
        content = (f"[ArcHeli] Task FAILED — {title}\n"
                   f"Skill: {skill_name}\nError: {error_msg[:300]}")
    ...
    def on_governor_blocked(self, action: str, reason: str,
        ...
        self._mem(f"[ArcHeli] Governor BLOCKED — {action}\nReason: {reason}",
    ...
    def on_goal_progress(self, goal_id: int, title: str,
        ...
        self._mem(f"[ArcHeli] Goal — {title}\n{old:.0%} → {new:.0%}\n{note}",
    ...
    def _mem(self, content: str, tags: list[str] | None = None,
        ...
        try:
            ...
            memory_store.add(content=content, source="archeli",
    ...
    def _jsonl(self, event_type: str, data: dict) -> None:
        try:
            ...
            log_file = log_dir / f"archeli_{datetime.utcnow():%Y-%m-%d}.jsonl"
